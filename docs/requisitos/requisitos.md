...
|---|---|---|---|---|
| Sprint 2 | `RF-01` a `RF-05` | Foram especificados os requisitos funcionais correspondentes às histórias de usuário existentes no Product Backlog. | Transformar as funcionalidades inicialmente descritas no backlog em requisitos verificáveis. | `US-01` a `US-05` / https://github.com/lucasensousa/coleta-mais/commit/c31df5af3ce6ea7c2be7d60e9e0ce8937359d50b |
| Sprint 2 | `RF-06` a `RF-12` | Foram adicionados requisitos funcionais relacionados às funcionalidades administrativas. | Definir as funcionalidades necessárias para o gerenciamento dos pontos de coleta pelo administrador. | `US-06` a `US-12` / https://github.com/lucasensousa/coleta-mais/commit/c31df5af3ce6ea7c2be7d60e9e0ce8937359d50b |
| Sprint 2 | `RN-01` a `RN-05` | Foram adicionadas regras de negócio relacionadas ao acesso administrativo e ao gerenciamento dos pontos de coleta. | Estabelecer condições que deverão ser respeitadas pelo sistema. | https://github.com/lucasensousa/coleta-mais/commit/c31df5af3ce6ea7c2be7d60e9e0ce8937359d50b |
| Sprint 2 | `RNF-01` a `RNF-06` | Foram adicionados requisitos não funcionais relacionados à qualidade e às restrições da aplicação. | Definir características verificáveis que a aplicação deverá atender. | https://github.com/lucasensousa/coleta-mais/commit/c31df5af3ce6ea7c2be7d60e9e0ce8937359d50b |
